					...
					<div class="panel">
						<div class="panel-body">
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="mailto:yashchandelak47@gmail.com "> 
									<i class="fa fa-envelope"></i> &nbsp; yashchandelak47@gmail.com 
								</a>
							</div>
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="callto:7972959483" style="margin-right: 8px;"> 
									<i class="fa fa-phone"></i> &nbsp; +917972959483
								</a>
								<a class="btn p-follow-btn" href="skype:live:.cid.5ed7daebee5e7820"> 
									<i class="fa fa-skype"></i> &nbsp; yash
								</a>
							</div>
						</div>
					</div>
