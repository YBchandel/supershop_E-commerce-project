							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>Ahmednagar</li>
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">+91 9090900909</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">imsstudent@gmail.com</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="//aamroni.info" target="_blank"> YASH CHANDEL</a>
						</p>
						...
						<div class="social-icons">
							<a href="https://aamroni.info" target="_blank" style="margin: 0px 10px;">
								<img src="public\assets\images\icons\yash.jpg" class="rounded-circle" style="width:32px; height:32px;">
							</a>				
