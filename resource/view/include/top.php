...
<html lang="en">
	<head>
		...
		<meta name="author" content="YASH CHANDEL">
				...
				<div class="header-top">
					<div class="container">
						<div class="header-left header-dropdowns">
							...
							<div class="header-dropdown">
								<a href="#"><img src="public\assets\images\favicon\istockphoto-177387875-170667a.jpg" alt="#127470">India</a>
								<div class="header-menu">
									<ul>
					...
					<div class="container">
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+91 9090900909</strong></a>
							</div>
